...
(function(){
  ...
  FTX.isPdfLocked = async function(file){
    try{ const t=pdfjsLib.getDocument({data:new Uint8Array(await file.arrayBuffer())}); const pdf=await t.promise; await pdf.destroy(); return false; }
